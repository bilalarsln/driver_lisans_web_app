    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteModalLabel">Kaynak Sil</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="deleteForm" action="{{ route('resourcedelete') }}" method="POST">
                    @csrf
                    ...
                    <center>
                        <h6>Kaynağı silmek istediğinizden emin misiniz?</h6>
