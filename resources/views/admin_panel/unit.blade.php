...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
                        ...
                        <table id="example" class="display">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('unit.updateActivity', $data->id) }}" method="POST">
                                            @csrf
                                            @method('PUT')
            ...
            <!-- Add Modal Start -->
            @include('admin_panel.part.unit_part.unitadd')
            <!-- Add Modal End -->

            <!-- Edit Modal Start -->
            @include('admin_panel.part.unit_part.unitupdate')
            <!-- Edit Modal End -->

            <!-- Delete Modal Start -->
            @include('admin_panel.part.unit_part.unitdelete')
            <!-- Delete Modal End -->
